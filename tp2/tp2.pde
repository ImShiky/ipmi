...
void draw() {
  ...
  if (slideActual == 20) {
    ...
    textFont(fuente20);
    fill(255);
    text("Fin. Haz clic para volver a comenzar.", 50, 380, 540, 80);
...
void mousePressed() {
  ...
  return; //este código checa, que se haya dado click para arrancar la presentación
}
  if (mostrarBoton) {
    slideActual = 1;
    tiempoInicio = millis();
    ...
    tam18 = 8;
    fade19 = 0;
    mostrarBoton = false; //toda esta parte del código reinicia todos los valores 
  }
}
